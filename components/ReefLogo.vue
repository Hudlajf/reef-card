<template>
  <a class="reef-logo" href="https://reef.io/" target="_blank">
    <svg
      class="reef-logo__logo"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      x="0px"
      y="0px"
      viewBox="-738.3 104.7 1154.9 583.5"
      style="enable-background: new -738.3 104.7 1154.9 583.5"
      xmlSpace="preserve"
    >
      <path
        class="reef-logo__dot"
        d="M284.1,494.3c-6.9,0-13.4,1.4-19.4,4.3c-6,2.7-11.2,6.4-15.7,11c-4.4,4.7-8,10.1-10.7,16.4
    ...
    C303.8,498,295,494.3,284.1,494.3z"
      ...
      <path
        class="reef-logo__reef"
        d="M412.6,229L412.6,229c-2.7-7.6-6.2-13.8-10.7-18.7c-4.2-4.9-9.2-8.6-15-11
